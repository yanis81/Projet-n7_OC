...
const { postBooks, getBooks, getBookById } = require("./controller/books.controller");
...
app.post("/api/books", upload.single("image"), postBooks); //Requete POST pour poster les nouveaux livres
